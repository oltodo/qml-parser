...
AstGeneratorBase::AstGeneratorBase(QQmlJS::Engine *engine, int level)
...
string AstGeneratorBase::toString(const Location &loc) {
  return toString(engine->code().mid(loc.startOffset, loc.length));
}
